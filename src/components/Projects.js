  ...
  const projectsSql = [
    {
      ...
      description:
        "A Machine Learning Project for the visualisation of image using Python and MySql. ",
      imgUrl: projImg3,
    },
  ];
          ...
          <Col size={12}>
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  <h2>Projects</h2>
                  <p>Hey! Here are the few glimpses of project made by me.</p>
                  <Tab.Container id="projects-tabs" defaultActiveKey="first">
                    ...
                    >
                      ...
                      <Nav.Item>
                        <Nav.Link eventKey="third">MySQL + ML</Nav.Link>
                      </Nav.Item>
                    </Nav>
                    <Tab.Content>
